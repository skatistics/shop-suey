  ...
  return (
    <div className="px-3 shadow-[0_5px_15px_rgba(0,0,0,0.3)] group/remove">
      ...
      <div className="flex justify-end items-center pb-6 pr-2 cursor-pointer space-x-2 ">
        <button className="absolute ml-5 text-sm opacity-0 scale-y-0 left-0 bg-ct-dark-green-9DC88D text-white font-bold px-2 rounded-full transition-transform duration-[400ms] group-hover/remove:opacity-100 group-hover/remove:scale-y-100">
          Remove
        </button>
